  ...
  <div class="col-12 col-md-9" style="border:3px solid black;height:90vh;"><br>
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>
          <?php if($result_project['Status_ID'] == '1') : ?>
            <a href="?Project_ID=<?php echo $Project_ID; ?>&menu=updateStatus&Status=3"
      ...
      <center><a href="?menu=Leader"><button class="btn btn-primary">เริ่มโครงการ</button></a></center>
